...
namespace SEE.Layout
{
    public class OptAlgorithm2 : GraphRenderer
    {
        ...
        public OptAlgorithm2(GraphSettings settings, float groundLevel, Graph graph, List<SublayoutNode> sublayoutNodes, Dictionary<Node, GameObject> nodeMap, InnerNodeFactory innerNodeFactory, NodeFactory leafNodeFactory) : base(settings)
        {
