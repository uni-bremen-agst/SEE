...
/// <summary>
/// Event class for passing on axis value from input to given function in editor.
/// The given function must have a float parameter in its head.
/// </summary>
[System.Serializable]
...
/// <summary>
/// This class makes it possible to map functions from other scripts in the editor to the controler events.
...
public class ViveControlerInteraction : MonoBehaviour
{
    ...
    private UnityEvent _OnLeftTrigger = null;
    ...
    private UnityEvent _OnRightTrigger = null;
