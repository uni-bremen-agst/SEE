...
namespace SEE.Controls
{
    ...
    public class RigMovement : MonoBehaviour
    {
        ...
        void Update()
        {
            HeightFactor = Mathf.Pow(gameObject.transform.position.y, 2) * 0.01f + 1;
            if (HeightFactor > 5)
            {
                HeightFactor = 5;
            }
        ...
        {
            gameObject.transform.Translate(direction * axis * HeightFactor);
        }
