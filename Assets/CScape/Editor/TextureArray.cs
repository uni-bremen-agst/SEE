...
public class TextureArray : MonoBehaviour
{
    ...
    [MenuItem("GameObject/CScapeTools/Create Texture Array Mask+Displace")]
    ...
    static void Create()
    {
        ...
        string filePattern = "diff_{0:000}";
        string filePatternAO = "depth_{0:000}";
        ...
        string path = "Assets/MaskDepthArray.asset";
