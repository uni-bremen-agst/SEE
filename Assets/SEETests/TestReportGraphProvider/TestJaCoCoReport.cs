    ...
    internal class TestJaCoCoReport : TestReportGraphProviderBase
    {
        ...
        private static Dictionary<string, Finding> CreateTestFindings()
        {
            ...
            Finding packageFinding = new Finding
            {
                ...
                Context = "package",
                Metrics = BuildMetrics(instructionMissed: 7,
                                       instructionCovered: 210,
                                       branchMissed: 1,
                                       branchCovered: 5,
                                       lineMissed: 3,
                                       lineCovered: 73,
            ...
            Finding classFinding = new Finding
            {
                ...
                Context = "class",
                Metrics = BuildMetrics(instructionMissed: 0,
                                       instructionCovered: 95,
                                       branchMissed: 1,
                                       branchCovered: 1,
                                       lineMissed: 0,
                                       lineCovered: 32,
            ...
            Finding execDumpClientSleepMethodFinding = new Finding
            {
                ...
                Metrics = BuildMetrics(instructionMissed: 5,
                                       instructionCovered: 5,
                                       branchMissed: null,
                                       branchCovered: null, // no BRANCH-Counter
                                       lineMissed: 1,
                                       lineCovered: 3,
                                       complexityMissed: 0,
                                       complexityCovered: 1,
