...
namespace SEETests
{
    public class TestDashboard
    {
        ...
        public void testDashboardInfo()
        {
            ...
            //FIXME There's a problem here where everything freezes when accessing an async method
            DashboardInfo info = null;
            Assert.DoesNotThrow(() => info = DashboardRetriever.Instance.GetDashboardInfo().Result);
