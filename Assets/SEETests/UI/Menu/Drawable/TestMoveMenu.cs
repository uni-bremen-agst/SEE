...
{
    /// <summary>
    /// Tests the Drawable move menu and its Mind Map specific child inclusion controls.
    /// </summary>
    [TestFixture]
    public class TestMoveMenu : DrawableMenuTestBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Destroys the move menu and all objects created for the current test.
        /// </summary>
        [TearDown]
        ...
        public void TestChildrenControlsAreHiddenForNonMindMapObject()
        {
            ...
            Assert.That(MoveMenu.Instance.IncludeChildren, Is.False);
        }

        /// <summary>
        /// Verifies that the child inclusion switch controls the include-children state
        /// for a Mind Map node.
        /// </summary>
        [Test]
        public void TestChildrenSwitchControlsIncludeChildrenState()
        {
            ...
            childrenSwitch.OnEvents.Invoke();
            Assert.That(MoveMenu.Instance.IncludeChildren, Is.True);

            childrenSwitch.OffEvents.Invoke();
            Assert.That(MoveMenu.Instance.IncludeChildren, Is.False);
        }

        /// <summary>
        /// Verifies that destroying the move menu clears the child inclusion state
        /// of the previous movement.
        /// </summary>
        [Test]
        public void TestDestroyResetsIncludeChildrenState()
        {
            GameObject selectedObject = CreateMindMapNode("SelectedNode");

            MoveMenu.Instance.Enable(selectedObject);

            FindChildrenSwitch().OnEvents.Invoke();
            Assert.That(MoveMenu.Instance.IncludeChildren, Is.True);
        ...
        private static SwitchManager FindChildrenSwitch()
        {
            ...
            Assert.Fail("Could not find the child inclusion switch of the move menu.");
            return null;
        }

        /// <summary>
        /// Creates and initializes a Mind Map node for the move menu tests.
        /// </summary>
