...
namespace SEE.UI.Menu.Drawable
{
    ...
    public class StickyNoteMoveMenu : SingletonMenu
    {
        ...
        public static void Enable(GameObject stickyNoteHolder, bool spawnMode = false)
        {
            ...
            SwitchManager speedUpManager = GameFinder.FindAttachedOrLocalDescendant(Instance.gameObject, "SpeedSwitch")
            ...
            GameFinder.FindAttachedOrLocalDescendant(Instance.gameObject, "Finish").GetComponent<ButtonManagerBasic>()
            ...
            GameFinder.FindAttachedOrLocalDescendant(Instance.gameObject, "Forward").AddComponent<ButtonHeld>().SetAction(() =>
            {
            ...
            GameFinder.FindAttachedOrLocalDescendant(Instance.gameObject, "Back").AddComponent<ButtonHeld>().SetAction(() =>
            {
            ...
            GameFinder.FindAttachedOrLocalDescendant(Instance.gameObject, "Info").GetComponent<ButtonManagerBasic>()
                .clickEvent.AddListener(() =>
            {
        ...
        {
            return GameFinder.FindAttachedOrLocalDescendant(Instance.gameObject, "SpeedSwitch")
