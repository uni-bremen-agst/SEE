    ...
    public class MoveMenu : SingletonMenu
    {
        ...
        private static void ControlChildren(GameObject selectedObject)
        {
            if (selectedObject.CompareTag(Tags.MindMapNode))
            {
                ...
                GameFinder.FindChild(Instance.gameObject, "Content").transform.Find("Rests").gameObject.SetActive(true);
            ...
            else
            {
                ...
                GameFinder.FindChild(Instance.gameObject, "Content").transform.Find("Rests").gameObject.SetActive(false);
                includeChildren = false;
            }
        }
