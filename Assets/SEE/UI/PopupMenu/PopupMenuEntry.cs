...
namespace SEE.UI.PopupMenu
{
    ...
    /// <param name="Priority">The priority of the entry. Entries with a higher priority
    /// are displayed first.</param>
    public record PopupMenuActionDoubleIcon(string Name, Action Action, char LeftIconGlyph, char RightIconGlyph, bool CloseAfterClick = true,
                                  int Priority = default) : PopupMenuAction(Name, Action, LeftIconGlyph, CloseAfterClick, Priority);
}
