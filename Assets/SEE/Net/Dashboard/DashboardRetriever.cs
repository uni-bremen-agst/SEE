...
namespace SEE.Net.Dashboard
{
    ...
    {
        private static string PublicKey = "3082020A0282020100B20ACB6E1639D673B6AF9E9F36578F66068AFDA50327DC2AB0F804E2F8"
        ...
        private static string BaseUrl = "https://stvive.informatik.uni-bremen.de:9443/axivion/projects/SEE/";

        private static string Token = "0.0000000000014.l-qjyU2eTKuNl7v0PsBb4qfI3sVHvtwKGGeOTKV_3eE";
        ...
        private void Start()
        {
            ...
            //TODO: Retrieve from PlayerSettings
            if (BaseUrl == null || Token == null || PublicKey == null)
            {
