...
namespace SEE.Net.Actions.Drawable
{
    ...
    /// </summary>
    public class EditLinePrimaryColorNetAction : DrawableNetAction
    {
        /// <summary>
        ...
        public EditLinePrimaryColorNetAction(string drawableID, string parentDrawableID, string lineName, Color color)
        ...
        /// <summary>
        /// Changes the primary color of the given line on each client.
        /// </summary>
