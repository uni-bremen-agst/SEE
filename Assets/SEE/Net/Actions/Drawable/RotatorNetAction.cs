...
namespace Assets.SEE.Net.Actions.Drawable
{
    public class RotatorNetAction : AbstractNetAction
    {
       ...
       // public Vector3 FirstPoint;
        ...
        public RotatorNetAction(string drawableID, string parentDrawableID, string objectName, Vector3 direction, float degree) : base()//, Vector3 firstPoint) : base()
        {
        ...
        public RotatorNetAction(string drawableID, string parentDrawableID, string objectName, float localEulerAnlgeZ) : base()//, Vector3 holderPosition, Vector3 objectPosition) : base()
        {
            DrawableID = drawableID;
            ParentDrawableID = parentDrawableID;
            ObjectName = objectName;
