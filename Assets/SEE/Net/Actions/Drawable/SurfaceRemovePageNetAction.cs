...
{/// <summary>
 ...
 /// </summary>
    public class SurfaceRemovePageNetAction : DrawableNetAction
    {
        /// <summary>
        ...
        public SurfaceRemovePageNetAction(DrawableConfig config, int page) : base(config.ID, config.ParentID)
        {
            Config = config;
            Page = page;
        }
