...
namespace SEE.XR
{
    ...
    internal class XRCameraRigManager : MonoBehaviour
    {
        ...
        /// </summary>
        internal const string LeftControllerName = "Camera Offset/LeftHand Controller"; //"Camera Offset/LeftHand Controller";
        ...
        /// controller to be enabled.
        /// </summary>
        internal const string RightControllerName = "Camera Offset/RightHand Controller"; //"Camera Offset/RightHand Controller";
