...
{
    /// <summary>
    /// Contains unicode characters for icons in the FontAwesome 6 free font.
    ///
    /// If you need to find out what a given icon looks like, search for the Unicode sequence
    /// (e.g. "F1B2") on https://fontawesome.com/icons. The first result should be the icon you're looking for.
    ///
    /// See https://github.com/uni-bremen-agst/SEE/wiki/Icons for more information.
    /// </summary>
