...
namespace SEE.Utils
{
    ...
    public static class Raycasting
    {
        ...
        internal static bool RaycastAnything(out RaycastHit raycastHit, Vector2 pointerPosition, float maxDistance = float.PositiveInfinity)
        {
            raycastHit = new RaycastHit();
            return !IsMouseOverGUI() && Physics.Raycast(MainCamera.Camera.ScreenPointToRay(pointerPosition), out raycastHit, maxDistance);
        }
