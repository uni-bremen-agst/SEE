...
namespace Assets.SEE.Tools.ReflexionAnalysis.AttractFunctions
{
    ...
    /// 
    /// The used prior probability are the number of observed documents per class. 
    /// 
    /// </summary>
    public class NaiveBayesIncremental : ITextClassifier
    {
        ...
        public bool IsEmpty()
        {
            foreach (string clazz in trainingData.Keys)
            {
                ...
                {
                    //TODO: Remove log
                    // UnityEngine.Debug.Log($"{clazz} was not resetted correctly. trainingData[{clazz}].DocumentCount={trainingData[clazz].DocumentCount}");
                    return false;
                }
                ...
                foreach (string word in wordFrequencies.Keys)
                {
                    ...
                    {
                        //TODO: Remove log
                        // UnityEngine.Debug.Log($"wordFrequencies were not resetted correctly. wordFrequencies[{word}]={wordFrequencies[word]}");
                        return false;
                    }
                }
            }
