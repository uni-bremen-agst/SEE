...
namespace SEE.Game
{
    ...
    public class ArchitectureInteraction : MonoBehaviour
    {
        ...
        /// </summary>
        public static readonly HashSet<string> ReflexionEdgeTypes = new()
        {
            Edge.Absence,
            Edge.Convergence,
            Edge.Divergence,
        ...
        /// </summary>
        public static readonly HashSet<string> ArchitectureEdgeTypes = new()
        {
            Edge.SourceDependency,
        };

        public static readonly HashSet<string> AllEdgeTypes = new();

        /// <summary>
        /// See property <see cref="ImplementationEdgeTypes"/>.
        /// </summary>
        private HashSet<string> implementationEdgeTypes = new();
        /// <summary>
        ...
        public HashSet<string> ImplementationEdgeTypes
        {
            get
            {
                if (implementationEdgeTypes.Count == 0)
                {
                    ...
                    {
                        Debug.Log($"implementation edge type {type}\n");
                    }
                }
