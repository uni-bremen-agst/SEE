...
namespace SEE.Game.Worlds
{
    ...
    public class PlayerSpawner : NetworkBehaviour
    {
        ...
        {
            Net.Network networkConfig = UserSetting.Instance.Network
            ...
            if (ReferenceEquals(dissonanceComms, null))
            {
                ...
                dissonanceComms.LocalPlayerName = UserSetting.Instance.Player.PlayerName;
            }
            ...
            if (networkManager.IsHost)
            {
                ...
                Spawn(networkManager.LocalClientId, UserSetting.Instance.Player.PlayerName, UserSetting.Instance.Player.AvatarIndex);
            }
        }
        ...
        private void OnClientIsConnected(ulong clientId)
        {
            ...
            SpawnOnServerRpc(clientId, UserSetting.Instance.Player.PlayerName, UserSetting.Instance.Player.AvatarIndex);
        }
