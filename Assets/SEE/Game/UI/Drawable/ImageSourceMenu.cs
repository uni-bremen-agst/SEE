    ...
    public static class ImageSourceMenu
    {
        ...
        public static void Enable()
        {
            if (instance == null)
            {
                ...
                ButtonManagerBasic local = GameFinder.FindChild(instance, "Local").GetComponent<ButtonManagerBasic>();
                ...
                ButtonManagerBasic web = GameFinder.FindChild(instance, "Web").GetComponent<ButtonManagerBasic>();
