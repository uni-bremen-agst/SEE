...
namespace SEE.Game.UI.CodeWindow
{
    ...
    public class SEEToken
    {
        ...
        /// </summary>
        /// <example>Red would be "FF0000".</example>
        ...
        /// </summary>
        public static SEEToken Keyword = new SEEToken("Keywords", "D988F2"); // purple
        /// <summary>
        /// Number literal tokens. This includes integer literals, floating point literals, etc.
        /// </summary>
        public static SEEToken NumberLiteral = new SEEToken("NumberLiterals", "D48F35"); // orange
        /// <summary>
        /// String literal tokens. This also includes character literals.
        /// </summary>
        public static SEEToken StringLiteral = new SEEToken("StringLiterals", "92F288"); // light green
        /// <summary>
        /// Punctuation tokens, such as separators and operators.
        /// </summary>
        public static SEEToken Punctuation = new SEEToken("Punctuation", "96E5FF"); // light blue
        /// <summary>
        /// Identifier tokens, such as variable names.
        /// </summary>
        public static SEEToken Identifier = new SEEToken("Identifiers", "FFFFFF"); // white
        /// <summary>
        /// Whitespace tokens, excluding newlines.
        /// </summary>
        public static SEEToken Whitespace = new SEEToken("Whitespace", "000000"); // color doesn't matter
        /// <summary>
        /// Newline tokens.
        /// </summary>
        public static SEEToken Newlines = new SEEToken("Newlines", "000000"); // color doesn't matter
        /// <summary>
        /// Unknown tokens, i.e. those not recognized by the lexer.
        /// </summary>
        public static SEEToken Unknown = new SEEToken("Unknown", "FFFFFF"); // white
