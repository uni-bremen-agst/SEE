...
namespace SEE.Controls.Actions
{
    ...
    /// </summary>
    internal class MoveNodeAction : AbstractPlayerAction
    {
        private struct Hit
        {
            ...
            /// <summary>
            /// The game object currently being hovered over.
            /// </summary>
        ...
        /// <summary>
        /// Returns a new instance of <see cref="MoveNodeAction"/>.
        /// </summary>
        /// <returns>new instance of <see cref="MoveNodeAction"/></returns>
        internal static ReversibleAction CreateReversibleAction() => new MoveNodeAction();

        /// <summary>
        /// Returns a new instance of <see cref="MoveNodeAction"/> that can continue
        /// with the user interaction so far.
        /// </summary>
        /// <returns>new instance</returns>
        public override ReversibleAction NewInstance() => new MoveNodeAction
        {
        ...
        private class Memento
        {
            ...
            /// May be the same value as <see cref="oldParent"/>.
        ...
        public override bool Update()
        {
            ...
            else if (SEEInput.Drag() && !SEEInput.DragHovered()) // start or continue moving a grabbed object
            {
                if (!moving && hoveredObject
                            && hoveredObject.transform != cityRootNode  // we cannot drag the city root node
                            && RaycastPlane(new Plane(Vector3.up, cityRootNode.position), out Vector3 planeHitPoint))
                {
                    // start movement of the hovered object; the hovered object becomes the dragged object
                    moving = true;
                ...
                if (moving
                    && RaycastLowestNode(out RaycastHit? raycastHit, out Node newParentNode, hit.node)) // continue movement
                {
            ...
            else if (moving)
            {
                ...
                if (hit.HoveredObject != cityRootNode) // only reparent non-root nodes
                {
