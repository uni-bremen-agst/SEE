  ...
  public class CirclePackingNodeLayout : NodeLayout, IIncrementalNodeLayout
  {
    ...
    private float PlaceNodes(ILayoutNode parent)
    {
      ...
      else
      {
        ...
        /*
        // Die Koordinaten, die in den Kreisen zurückgegeben werden, sind lokal, d.h. relativ zum Nullpunkt.
        // Das resultierende Zentrum und der outOuterRadius beziehen sich auf das Kreisobjekt, das die
        // gerade gepackten Kinder umfasst. Notwendigerweise ist das Objekt, dessen Kinder wir
        // aktuell verarbeiten, ein zusammengesetztes Objekt, das durch einen Kreis dargestellt wird, andernfalls
        // hätten wir hier keine Kinder.
