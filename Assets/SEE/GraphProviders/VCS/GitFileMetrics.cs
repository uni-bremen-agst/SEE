...
namespace SEE.GraphProviders.VCS
{
    ...
    public class GitFileMetrics
    {
        ...
        /// </summary>
        public ISet<GitFileAuthor> Authors { get; set; }
        ...
        /// </summary>
        public IDictionary<GitFileAuthor, int> AuthorsChurn { get; set; }
        ...
        public GitFileMetrics(int numberOfCommits, HashSet<GitFileAuthor> authors, int churn)
        {
            NumberOfCommits = numberOfCommits;
            Authors = authors;
            Churn = churn;
            AuthorsChurn = new Dictionary<GitFileAuthor, int>();
