...
namespace SEE.Scanner.Antlr
{
    ...
    public class AntlrLanguage : TokenLanguage
    {
        ...
        public static AntlrLanguage GetTokenLanguageByType(AntlrLanguageType type)
        {
            switch (type)
            {
                case AntlrLanguageType.Plain:
                    return Plain;
                case AntlrLanguageType.Java:
                    return Java;
                case AntlrLanguageType.CSharp:
                    return CSharp;
                case AntlrLanguageType.CPP:
                    return CPP;
            }
