...
//    public readonly Dictionary<string, GameObject> circleTexts = new Dictionary<string, GameObject>();
...
//        if (plane != null)
//        {
//            SEE.Destroyer.DestroyGameObject(plane);
//        }
//    }
...
//        if (oldLayout != null)
//        {
//            plane = oldLayout.plane;
//        }
//        else
//        {
//            plane = GameObject.CreatePrimitive(PrimitiveType.Plane);
//            plane.name = "RootPlane";
...
//    private GameObject getNewOrOldBlock(Node node)
//    {
//        GameObject block;
//        NodeRef noderef;
//        if (oldLayout != null && oldLayout.nodes.ContainsKey(node.LinkName))
//        {
//            var oldNode = oldLayout.nodes[node.LinkName];
//            block = oldLayout.gameObjects[oldNode];
//            oldLayout.gameObjects.Remove(oldNode);
//            oldLayout.nodes.Remove(oldNode.LinkName);
//            noderef = block.GetComponent<NodeRef>();
//        }
//        else
//        {
...
//        // TODO for Testpurpose
//        Vector3 baseSize = new Vector3(10, 10, 10);
...
//            var block = getNewOrOldBlock(node);
//            Vector3 scale;
//            {
//                // The block's width and breadth are proportional to the two metrics.
//                scale = new Vector3(scaler.GetNormalizedValue(node, widthMetric),
...
//            Debug.LogWarning("House Size: " + size + " - " + baseSize + " - " + scale);

//            Vector3 newScale = new Vector3(baseSize.x / size.x, baseSize.y / size.y, baseSize.z / size.z);
//            block.transform.localScale = newScale;


//            float diagonal = Mathf.Sqrt(baseSize.x * baseSize.x + baseSize.z * baseSize.z);
...
//    private GameObject getNewOrOldInnerCircle(Node node)
//    {
//        GameObject circle;
//        NodeRef noderef;
//        if (oldLayout != null && oldLayout.nodes.ContainsKey(node.LinkName))
//        {
//            var oldNode = oldLayout.nodes[node.LinkName];
//            circle = oldLayout.gameObjects[oldNode];
//            oldLayout.gameObjects.Remove(oldNode);
//            oldLayout.nodes.Remove(oldNode.LinkName);
//            noderef = circle.GetComponent<NodeRef>();
//        }
//        else
//        {
...
//    {
//        GameObject circle = getNewOrOldInnerCircle(node);
...
//        GameObject text;
//        if (oldLayout != null && oldLayout.circleTexts.ContainsKey(node.LinkName))
//        {
//            text = oldLayout.circleTexts[node.LinkName];
//            oldLayout.circleTexts.Remove(node.LinkName);
//            ExtendedTextFactory.UpdateText(text, node.SourceName, position, 2.0f * radius * 0.3f);
//        }
//        else
//        {
//            text = TextFactory.GetText(node.SourceName, position, 2.0f * radius * 0.3f);
//        }
//        circleTexts.Add(node.LinkName, text);
...
//            }
//        }
//        Debug.LogWarning("Maximal Node Height: " + result.y);
//        return result;
//    }
//}