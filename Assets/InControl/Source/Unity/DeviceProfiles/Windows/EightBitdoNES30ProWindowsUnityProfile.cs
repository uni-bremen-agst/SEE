...
namespace InControl.UnityDeviceProfiles
{
	...
	public class EightBitdoNES30ProWindowsUnityProfile : InputDeviceProfile
	{
		public override void Define()
		{
			...
			DeviceNotes = "8Bitdo NES30 Pro Controller on Windows";
			...
			Matchers = new[]
			{
				new InputDeviceMatcher { NameLiteral = "8Bitdo NES30 Pro" },
				new InputDeviceMatcher { NameLiteral = "Bluetooth Wireless Controller   " }
			};
