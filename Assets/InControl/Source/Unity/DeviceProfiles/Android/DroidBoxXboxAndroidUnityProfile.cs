...
namespace InControl.UnityDeviceProfiles
{
	...
	public class DroidBoxXboxAndroidUnityProfile : InputDeviceProfile
	{
		...
		public override void Define()
		{
			...
			DeviceName = "DroidBOX GPD XD PlayON - Xbox Mode";
			DeviceNotes = "DroidBOX GPD XD PlayON - Xbox Mode on Android";
			...
			Matchers = new[] { new InputDeviceMatcher { NameLiteral = "XBOX" } };
