...
namespace InControl.UnityDeviceProfiles
{
	...
	public class XboxOneMacFirefoxUnityProfile : InputDeviceProfile
	{
		public override void Define()
		{
			...
			DeviceNotes = "Xbox One Controller on Mac Firefox";
			...
			Matchers = new[] { new InputDeviceMatcher { NameLiteral = "Xbox One Wired Controller (STANDARD GAMEPAD Vendor: 045e Produc" } };
