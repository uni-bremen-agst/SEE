...
namespace InControl
{
	...
	[CustomPropertyDrawer( typeof(OptionalInputDeviceTransportType) )]
	class OptionalInputDeviceTransportTypePropertyDrawer : PropertyDrawer
	{
		public override void OnGUI( Rect position, SerializedProperty property, GUIContent label )
		{
			...
			{
				GUI.Label( valueRect, "Empty (Optional Transport Type)", "TextField" );
			}
