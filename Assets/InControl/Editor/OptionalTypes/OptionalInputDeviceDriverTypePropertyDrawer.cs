...
namespace InControl
{
	...
	[CustomPropertyDrawer( typeof(OptionalInputDeviceDriverType) )]
	class OptionalInputDeviceDriverTypePropertyDrawer : PropertyDrawer
	{
		public override void OnGUI( Rect position, SerializedProperty property, GUIContent label )
		{
			...
			{
				GUI.Label( valueRect, "Empty (Optional Driver Type)", "TextField" );
			}
