...
{
    /// <summary>
    /// Rule tests for DOC142: invalid XML documentation tags (syntactically invalid tag name).
    /// </summary>
    public sealed class DOC142_InvalidXmlTagTests
    {
        /// <summary>
        ...
        /// <summary>
        /// Ensures that well-formed, known tags do not produce DOC142 findings.
        /// </summary>
        [Fact]
