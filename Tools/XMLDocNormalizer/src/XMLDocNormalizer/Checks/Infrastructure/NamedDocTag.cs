...
{
    /// <summary>
    /// Represents a documentation XML element that references a declared name via a <c>name</c> attribute.
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="NamedDocTag"/> struct.
    /// </remarks>
    /// <param name="name">The referenced declared name extracted from the <c>name</c> attribute.</param>
