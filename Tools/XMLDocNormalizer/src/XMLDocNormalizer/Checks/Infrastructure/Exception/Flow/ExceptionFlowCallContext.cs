...
namespace XMLDocNormalizer.Checks.Infrastructure.Exception.Flow
{
    ...
    internal sealed class ExceptionFlowCallContext
    {
        ...
        /// call.
        /// </summary>
        private readonly Dictionary<int, ExceptionFlowValueFacts>
            parameterFacts;
        ...
        public ExceptionFlowCallContext(
            ...
            : this(
                callableSymbol,
                Array.Empty<
                    KeyValuePair<int, ExceptionFlowValueFacts>>())
        {
        }

        /// <summary>
        /// Initializes a new instance of the
        /// <see cref="ExceptionFlowCallContext"/> class.
        /// </summary>
        /// <param name="callableSymbol">
        /// The callable symbol whose body is being analyzed.
        /// </param>
                ...
                knownParameterFacts)
        {
            ...
            parameterFacts =
                new Dictionary<int, ExceptionFlowValueFacts>();

            foreach (KeyValuePair<
                         int,
                         ExceptionFlowValueFacts> pair
        ...
        /// <summary>
        /// Gets a deterministic key that identifies the known parameter
        /// facts.
        /// </summary>
        /// <value>
        /// A comma-separated sequence of sorted parameter indexes and their
        /// fact values, or an empty string if no parameter facts are known.
        /// </value>
        ...
        /// <exception cref="ArgumentNullException">
        /// Thrown when
        /// <paramref name="knownNonNullParameterIndexes"/> is
        /// <see langword="null"/>.
        /// </exception>
        ...
        /// supplied.
        /// </returns>
        private static ISymbol? NormalizeSymbol(
            ISymbol? symbol)
        {
