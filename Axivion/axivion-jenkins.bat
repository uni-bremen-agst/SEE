...
"C:\Program Files\Unity\Hub\Editor\2022.3.15f1\Editor\Unity.exe" -batchmode -nographics -logFile - -executeMethod CITools.SolutionGenerator.Sync -projectPath . -quit
REM "C:\Program Files\Unity\Hub\Editor\2022.3.15f1\Editor\Unity.exe" -batchmode -nographics -logFile - -executeMethod UnityEditor.SyncVS.SyncSolution -projectPath . -quit
