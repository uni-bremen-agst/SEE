...
"C:\Program Files\Unity\Hub\Editor\2022.3.9f1\Editor\Unity.exe" -batchmode -nographics -logFile - -executeMethod UnityEditor.SyncVS.SyncSolution -projectPath . -quit
"C:\Program Files\Unity\Hub\Editor\2022.3.9f1\Editor\Unity.exe" -batchmode -nographics -logFile - -executeMethod UnityEditor.SyncVS.SyncSolution -projectPath . -quit
